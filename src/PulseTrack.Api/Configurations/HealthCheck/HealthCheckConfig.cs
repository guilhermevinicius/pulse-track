...
namespace PulseTrack.Api.Configurations.HealthCheck;

internal static class HealthCheckConfig
{
    internal static void AddHealthCheckConfiguration(this IServiceCollection services, IConfiguration configuration)
    {
